    ...
    <section className="pb-24 pt-8">
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        <ScrollReveal className="mb-10 text-center">
          ...
          <h2 className="mt-3 font-display text-3xl text-white md:text-5xl">Answers upfront</h2>
        </ScrollReveal>
        ...
        <div className="space-y-3">
          {FAQ_ITEMS.map((item, i) => {
            ...
            return (
              <div
                key={item.q}
                className="overflow-hidden rounded-2xl border border-white/10 bg-ss-blue-900/50 shadow-sm backdrop-blur-sm"
              >
                <button
                  type="button"
